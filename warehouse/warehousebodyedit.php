...
<body>
    <h3>Aufgraggeber:</h3>
    <h3><?php echo (getorderer($_SESSION['rorder'])) ?></h3>
    <h3>Auftragsnummer:</h3>
    <h3><?php echo($_SESSION['rorder']); ?></h3>
    <h3>Auftragsstatus:</h3>
    <h3><?php
    if(getorderstate($_SESSION['rorder']) == 'ordering') echo("OK");
    else echo(getorderstate($_SESSION['rorder'])); ?></h3>
    ...
    <table>
        ...
        <?php listallorderview($_SESSION["rorder"],0)?>
    </table>
    </form>
</body>