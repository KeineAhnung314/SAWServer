...
$orderlist = listOrders($_SESSION["rorder"]);
$loc = 2;
...
<body>
    ...
    <div class="main" id="main">
        <a href="/warehouse/watchorders.php" class="back">&#x2190;</a>
        <div class="top">
            <div class="dashboard">
                <h4>Aufgraggeber:</h4>
        ...
        <div class="sales">
            ...
            <?php if ($orderlist["fixable"]) echo ("<a href=\"/modules/formhandler/repairorderhandler.php\" class=\"btn\">Bestellung Repariert</a>"); ?>
        </div>
    </div>
</body>
