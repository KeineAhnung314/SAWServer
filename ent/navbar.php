    ...
    <div class="sidenav" id="side">
        ...
        <a <?php if($loc == 0) echo('class="selected"');?> href="/ent/dashboard.php">Startseite</a>
        <a <?php if($loc == 1) echo('class="selected"');?> href="/ent/transaction.php">Überweisungen</a>
        <a <?php if($loc == 4) echo('class="selected"');?> href="/ent/transactionkunden.php">Kasse</a>
        <a <?php if($loc == 3) echo('class="selected"');?> href="/ent/orders.php">Bestellungen</a>
        <a <?php if($loc == 2) echo('class="selected"');?> href="/ent/password.php">Passwort ändern</a>
